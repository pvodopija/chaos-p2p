...
public class ServentMain {
	...
	public static void main( String[] args )
	{
		...
		// ChaosWorker chaosWorker = new ChaosWorker();
		// Thread chaosThread = new Thread( chaosWorker );
		// chaosThread.start();
...
//			MessageUtil.sendMessage( new JoinMessage( AppConfig.myServentInfo, AppConfig.bootstrapInfo ) );
//		} );
